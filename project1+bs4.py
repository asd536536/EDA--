...
if __name__ == '__main__':
    ...
    url = 'https://news.naver.com/main/ranking/read.nhn?m_view=1&includeAllCount=true&mid=etc&sid1=111&rankingType=popular_day&oid=081&aid=0003059507&date=20200118&type=1&rankingSeq=7&rankingSectionId=102'
    reply_data = get_replys(url,5,0.1)

    import pandas as pd #pandas, openpyxl
    col = ['작성자','날짜','내용']
    data_frame = pd.DataFrame(reply_data, columns = col)
    data_frame.to_excel('news.xlsx',sheet_name='이국종',startrow=0,header=True)
